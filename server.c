...
int n; FILE *fp; char *filename = outputFile; 
char buffer[SIZE]; 
...
char *ip = "127.0.0.1"; int port = 8080; int e; int listenfd, connfd, n; pid_t childpid; 
socklen_t clilen; 
...
//close listening socket close (listenfd); write_file(new_sock,argv[1]); 
